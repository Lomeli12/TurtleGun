package net.lomeli.turtlegun.client.techne.model;
...
import net.lomeli.turtlegun.client.techne.model.components.*;
    ...
    public ModelTechne2(TC2Info info) {
        for (TC2Info.Model model : info.Techne.Models) {
            try {
                ...
                TurtleGun.logger.logError("Error parsing Techne 2 model: Invalid number");
                e.printStackTrace();
            } catch (ArrayIndexOutOfBoundsException e) {
                TurtleGun.logger.logError("Error parsing Techne 2 model: Array too short");
            }
        }
    }
