package net.lomeli.turtlegun.client.techne.model.components;
...
public class ModelPart {
    ...
    public boolean render(boolean bindTexture, float f5) {
        if (bindTexture) {
            if (image == null) {
                TurtleGun.logger.logError("A Techne 2 model part is trying to render without a texture! Removing from overall Model Parts.");
                return false;
            }
            if (imageId == -1)
